...
#+CAPTION: HTML code for Figure 6.2.
#+BEGIN_SRC html
...
that is required to achieve the layout in Figure 6.2 but using \thp{} and \tgf{}
instead of HTML is shown below, again note that some additional styling code is
not shown.

#+CAPTION: \thp{} code for Figure 6.2.
#+BEGIN_SRC haskell
flex_p UI.div [
      (foo, flexGrow 1)
    , (foo, flexGrow 2)
