...
All code is online on GitHub. Some repositories do not only contain our code, to
...
The \tgc{} library (right-click menus for \thp{}) produced can be found at:

https://github.com/barischj/threepenny-gui-contextmenu

The \tgf{} library (Flexbox combinators for \thp{}) produced can be found at:
