...
-- @HeinrichApfelmus on Pull Request #169
#+END_QUOTE
...
# REF http://hackage.haskell.org/package/threepenny-gui-0.8.0.0/docs/Graphics-UI-Threepenny-Attributes.html
...
selector to turn it into a directory selector.
