...
# Implementation.
In each of these cases we have a variable, accessible application-wide, which
...
update themselves. This paragraph relates closely to Figure [[fig:indirect-frp]].
